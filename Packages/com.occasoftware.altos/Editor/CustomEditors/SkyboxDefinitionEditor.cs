    ...
    public class SkyboxDefinitionEditor : UnityEditor.Editor
    {
        ...
        private void DrawTimeSettings()
        {
            ...
            if (showTimeSettings)
            {
                ...
                EditorGUI.indentLevel++;
                GUIContent dayContent = new GUIContent(
                    "Day " + skyDefinition.CurrentDay,
                    "Represents the current in-game day. Always initializes as 0. Not settable."
                );
                ...
                GUIContent timeContent = new GUIContent(
                    "Time " + timeActive.ToString("hh':'mm':'ss"),
                    "Represents the current in-game time for a particular day."
                );
