...
namespace OccaSoftware.Altos.Runtime
{
    ...
    public class AltosSkyDirector : MonoBehaviour
    {
        ...
        private bool ValidateSetup()
        {
            ...
            Debug.LogError(
                "This version of Altos is designed for Unity 2021.3 or newer. Please upgrade your Unity Editor to ensure that Altos is compatible with your Unity version."
            );
#endif
