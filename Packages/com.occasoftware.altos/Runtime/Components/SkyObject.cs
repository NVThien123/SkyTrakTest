        ...
        */
        ...
        private bool UpdateLightProperties()
        {
            ...
            else
            {
                ...
                intensity = Mathf.Lerp(0f, peakIntensity, t);
                temperature = 2000f + 3500f * t;
            }
        ...
        private void DrawUpperArc(float euclidianDistance)
        {
            UnityEditor.Handles.DrawWireArc(
                earth.transform.position + new Vector3(0, 0, positionRelative.z),
                Vector3.forward,
                Vector3.right,
                180f,
                euclidianDistance,
        ...
        private void DrawText()
        {
            ...
            UnityEditor.Handles.Label(
                child.transform.position + offset * 3f,
                new GUIContent(
                    $"\n\ndiameter\n {angularDiameterDegrees:0.00}°\n\norbit\n {orbitOffset:0.00}°\n\ninclination\n {inclinationOffset:0.00}°\n\nintensity\n {GetLight().intensity:0.00}"
                ),
                s
            );
