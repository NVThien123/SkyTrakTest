...
namespace OccaSoftware.Altos.Runtime
{
    ...
    public class SkyDefinition : ScriptableObject
    {
        ...
        public void SetLightingEnvironment(SkyColorSet skyColorSet)
        {
            ...
            RenderSettings.ambientGroundColor = Exposure(
                Saturation(skyColorSet.groundColor, environmentLightingSaturation),
                environmentLightingExposure
            );
            RenderSettings.ambientEquatorColor = Exposure(
                Saturation(skyColorSet.equatorColor, environmentLightingSaturation),
                environmentLightingExposure
            );
