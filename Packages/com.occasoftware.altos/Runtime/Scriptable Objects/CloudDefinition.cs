...
namespace OccaSoftware.Altos.Runtime
{
    ...
    {
        private const string _VOLUME_TEXTURE_DIRECTORY =
            "Packages/com.occasoftware.altos/Textures/Noise Textures/VolumeTextures/";
        ...
        private void Setup()
        {
            planetRadius = GetRadiusFromCelestialBodySelection(
            ...
            detail1Texture = LoadVolumeTexture(
                detail1TextureID,
                detail1TextureQuality,
                detail1Texture
            );
            ...
            if (
                depthCullOptions == DepthCullOptions.RenderLocal
                && renderScaleSelection == RenderScaleSelection.Quarter
            )
            {
                renderScaleSelection = RenderScaleSelection.Half;
                Debug.Log(
                    "The quarter size render scale option is unavailable when depth culling is set to render local."
                );
            }
        ...
        public bool lowAltitudeModelingState = true;
        public bool lowAltitudeLightingState = true;
        public bool lowAltitudeWeatherState = true;
        public bool lowAltitudeBaseState = true;
        public bool lowAltitudeDetail1State = true;
        public bool lowAltitudeDetail2State = true;
        public bool lowAltitudeCurlState = true;
        #endregion
        ...
        /// </summary>
        public float taaBlendFactor = 0.03f;
        ...
        /// </summary>
        public Vector3 baseTextureScale = new Vector3(150f, 150f, 150f);
        ...
        /// </summary>
        public Vector3 detail1TextureScale = new Vector3(300f, 300f, 300f);
        ...
        /// <returns></returns>
        private int GetRadiusFromCelestialBodySelection(
        ...
        /// <returns></returns>
        private float GetRenderScalingFromRenderScaleSelection(
            RenderScaleSelection renderScaleSelection
        )
        {
